...
using UnityEngine;
public class PedistrianController1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        distanceX = Car.GetComponent<CarController>().floatValues[1] / 128;
        distanceY = Car.GetComponent<CarController>().floatValues[2] / 128; // distanceY = distanceZ in unity space
